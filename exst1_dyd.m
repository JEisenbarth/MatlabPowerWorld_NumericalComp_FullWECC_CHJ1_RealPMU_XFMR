function [flag] = exst1_dyd(fileID,n,name,kv,id,Tr,Vimax,Vimin,Tc,Tb,Ka,Ta,Vrmax,Vrmin,Kc,Kf,Tf,Tc1,Tb1,Vamax,Vamin,Xe,Ilr,Klr)
%exst1_dyd This function will write the PSLF exst1 model to a dyd file.
...
flag=1;
fprintf(fileID,'exst1     %s "%s" %s "%s" : #0 %s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s \n',...
    n,name,kv,id,Tr,Vimax,Vimin,Tc,Tb,Ka,Ta,Vrmax,Vrmin,Kc,Kf,Tf,Tc1,Tb1,Vamax,Vamin,Xe,Ilr,Klr);
flag=0;
